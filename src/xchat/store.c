 ...
 * stored in CONFIG_DIR/xchat/20140301044819/20140307.txt, where the first
 * part matches the keyset (found in CONFIG_DIR//contacts/20140301044819/),
